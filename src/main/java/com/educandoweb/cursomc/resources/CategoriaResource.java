...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO objDto) { // @RequestBody converte, automaticamente, um objeto Json em um objeto Java.
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
			@RequestParam(value = "page", defaultValue = "0") Integer page,  // @RequestParam estabelece um parâmetro como opcional 
